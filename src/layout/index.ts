...
export class UICalculated {
  ...
  width_override: number = 0;
  lineBreak: boolean = false;
  absolute: boolean = false;
}

const UICompRegistry: { [key: string]: string } = {};
...
export class EVG {
  ...
  left = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };
  top = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };

  // fix: bottom is set
  bottom = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };
  right = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };

  id = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };

  // fix: CNAME = component name
  cname = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };

  width = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };
  height = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };
  inline = { unit: 0, is_set: false, pixels: 0.0, b_value: false, s_value: "" };
  direction = {
    unit: 0,
    is_set: false,
    pixels: 0.0,
  ...
  align = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };
  verticalAlign = {
    unit: 0,
    is_set: false,
    pixels: 0.0,
  ...
  opacity = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };
  rotate = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };
  borderWidth = {
    unit: 0,
    is_set: false,
    pixels: 0.0,
  ...
  // FIX: add scale
  scale = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };

  // FIX: add viewport
  svgPath = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };
  viewBox = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };

  imageUrl = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };
  text = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };
  ...
  margin = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };
  marginLeft = {
    unit: 0,
    is_set: false,
    pixels: 0.0,
  ...
  padding = { unit: 0, is_set: false, pixels: 0.0, f_value: 0.0, s_value: "" };
  paddingLeft = {
    unit: 0,
    is_set: false,
    pixels: 0.0,
    ...
    try {
      ...
      */
      ...
      if (jsonDict["verticalAlign"] || jsonDict["vertical-align"]) {
        var value_verticalAlign =
          jsonDict["verticalAlign"] || jsonDict["vertical-align"];
      ...
      if (jsonDict["fontFamily"] || jsonDict["font-family"]) {
        var value_fontFamily =
          jsonDict["fontFamily"] || jsonDict["font-family"];
      ...
      if (jsonDict["backgroundColor"] || jsonDict["background-color"]) {
        var value_backgroundColor =
          jsonDict["backgroundColor"] || jsonDict["background-color"];
      ...
      if (jsonDict["linear-gradient"] || jsonDict["linearGradient"]) {
        var value_linearGradient =
          jsonDict["linearGradient"] || jsonDict["linear-gradient"];
      ...
      if (jsonDict["borderWidth"] || jsonDict["border-width"]) {
        var value_borderWidth =
          jsonDict["borderWidth"] || jsonDict["border-width"];
      ...
      if (jsonDict["borderColor"] || jsonDict["border-color"]) {
        var value_borderColor =
          jsonDict["borderColor"] || jsonDict["border-color"];
        this.borderColor.s_value = value_borderColor;
        this.borderColor.is_set = true;
      }
      if (jsonDict["borderRadius"] || jsonDict["border-radius"]) {
        var value_borderRadius =
          jsonDict["borderRadius"] || jsonDict["border-radius"];
      ...
      if (jsonDict["svgPath"] || jsonDict["path"] || jsonDict["d"]) {
        var value_svgPath =
          jsonDict["svgPath"] || jsonDict["path"] || jsonDict["d"];
      ...
      if (jsonDict["marginLeft"] || jsonDict["margin-left"]) {
        var value_marginLeft =
          jsonDict["marginLeft"] || jsonDict["margin-left"];
      ...
      if (jsonDict["marginRight"] || jsonDict["margin-right"]) {
        var value_marginRight =
          jsonDict["marginRight"] || jsonDict["margin-right"];
      ...
      if (jsonDict["marginBottom"] || jsonDict["margin-bottom"]) {
        var value_marginBottom =
          jsonDict["marginBottom"] || jsonDict["margin-bottom"];
      ...
      if (jsonDict["paddingLeft"] || jsonDict["padding-left"]) {
        var value_paddingLeft =
          jsonDict["paddingLeft"] || jsonDict["padding-left"];
      ...
      if (jsonDict["paddingRight"] || jsonDict["padding-right"]) {
        var value_paddingRight =
          jsonDict["paddingRight"] || jsonDict["padding-right"];
      ...
      if (jsonDict["paddingBottom"] || jsonDict["padding-bottom"]) {
        var value_paddingBottom =
          jsonDict["paddingBottom"] || jsonDict["padding-bottom"];
      ...
      if (jsonDict["paddingTop"] || jsonDict["padding-top"]) {
        var value_paddingTop =
          jsonDict["paddingTop"] || jsonDict["padding-top"];
      ...
      if (jsonDict["shadowColor"] || jsonDict["shadow-color"]) {
        var value_shadowColor =
          jsonDict["shadowColor"] || jsonDict["shadow-color"];
        this.shadowColor.s_value = value_shadowColor;
        this.shadowColor.is_set = true;
      }
      if (jsonDict["shadowOffsetX"] || jsonDict["shadow-offset-x"]) {
        var value_shadowOffsetX =
          jsonDict["shadowOffsetX"] || jsonDict["shadow-offset-x"];
      ...
      if (jsonDict["shadowOffsetY"] || jsonDict["shadow-offset-y"]) {
        var value_shadowOffsetY =
          jsonDict["shadowOffsetY"] || jsonDict["shadow-offset-y"];
      ...
      if (jsonDict["shadowOpacity"] || jsonDict["shadow-opacity"]) {
        var value_shadowOpacity =
          jsonDict["shadowOpacity"] || jsonDict["shadow-opacity"];
      ...
      if (jsonDict["shadowRadius"] || jsonDict["shadow-radius"]) {
        var value_shadowRadius =
          jsonDict["shadowRadius"] || jsonDict["shadow-radius"];
  ...
  readXMLDoc(node: any, parentNode: any) {
    ...
    */
    if (node.nodeType === 3 || node.nodeType === 4) {
      ...
      const lines = str
        .split(" ")
        .filter((_: string) => _.trim().length)
        .map((_: string, i: number, arr: any[]) => {
          const n = new EVG("");
          n.tagName = "Label";
          n.text.is_set = true;
  ...
  default_layout(node: EVG, render_pos: UIRenderPosition) {
    ...
    if (node.direction.is_set && node.direction.s_value == "bottom-to-top") {
      for (var ii = 0; ii < node.items.length; ii++) {
        ...
        if (
          childNode.calculated.lineBreak ||
      ...
      if (
        (node.align.is_set && node.align.s_value == "right") ||
        ...
        if (
          ...
          if (node.align.is_set && node.align.s_value == "fill") {
            ...
            for (var i2 = 0; i2 < current_row.length; i2++) {
              var row_item = current_row[i2];
              const divider =
                current_row.length > 1 ? current_row.length - 1 : 1;
          ...
          if (
            childNode.calculated.height > line_height &&
