...
export class EVG {
  ...
  direction = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  align = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  verticalAlign = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  ...
  color = {  unit : 0, is_set : false, f_value : 0.0, s_value : "" , color : "#000000" }
  backgroundColor = {  unit : 0, is_set : false, f_value : 0.0, s_value : "" , color : "#000000" }
  opacity = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  rotate = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  borderWidth = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  borderColor = {  unit : 0, is_set : false, f_value : 0.0, s_value : "" , color : "#000000" }
  borderRadius = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  ...
  vColorSlide = { unit : 0, is_set : false, f_value : 0.0, s_value : "", b_value : false }
  vColorSlideBreak = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  vColorSlideTop = {  unit : 0, is_set : false, f_value : 0.0, s_value : "" , color : "#000000" }
  vColorSlideBottom = {  unit : 0, is_set : false, f_value : 0.0, s_value : "" , color : "#000000" }
  margin = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  marginLeft = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  marginRight = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  marginBottom = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  marginTop = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  padding = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  paddingLeft = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  paddingRight = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  paddingBottom = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  paddingTop = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  shadowColor = {  unit : 0, is_set : false, f_value : 0.0, s_value : "" , color : "#000000" }
  shadowOffsetX = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  shadowOffsetY = { unit : 0, is_set : false, pixels : 0.0, f_value : 0.0, s_value : "" }
  ...
  convertStrToValue = function( str ) {
    var b_had = false;
    var type  = 0;
    var value = 0.0;
      ...
      for(var i=0; i<node.childNodes.length; i++) {
        ...
        if(Array.isArray(childUI)) {
          ...
          if( childUI && childUI.tagName == 'component') {
            ...
            if(compDef) {
              register_component( childUI.id.s_value, serializer.serializeToString( compDef ) )
            }
            continue
          }          
