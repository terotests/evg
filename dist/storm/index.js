...
__export(index_exports, {
  EVG_EDITION: () => EVG_EDITION,
  EVG_STORM_VERSION: () => EVG_STORM_VERSION,
  Storm: () => Storm,
  default: () => index_default,
  fromLegacyEVG: () => fromLegacyEVG,
  isStormDocument: () => isStormDocument,
  parse: () => parse,
  parseStorm: () => parseStorm,
  parseStormJson: () => parseStormJson,
  renderToFile: () => renderToFile,
  stormToJson: () => stormToJson,
  stormToXml: () => stormToXml,
  toLegacyEVG: () => toLegacyEVG
});
module.exports = __toCommonJS(index_exports);

// src/storm/types.ts
var EVG_STORM_VERSION = "3.0.0";
var EVG_EDITION = "Storm";
function isStormDocument(value) {
...
function stormToXml(doc) {
  return nodeToXml(doc.root, 0) + "\n";
}
function parseStormJson(input) {
...
function stormToJson(doc, pretty = false) {
...
function legacyNode(node) {
  ...
  const out = { tag };
  const id = (_a = node.id) == null ? void 0 : _a.s_value;
  if (id) out.id = id;
  const text = (_b = node.text) == null ? void 0 : _b.s_value;
  ...
  setProp(props, "font-family", ((_c = node.fontFamily) == null ? void 0 : _c.is_set) ? node.fontFamily.s_value : void 0);
  ...
  setProp(props, "overflow", ((_d = node.overflow) == null ? void 0 : _d.is_set) ? node.overflow.s_value : void 0);
  ...
  setProp(props, "text-align", ((_e = node.align) == null ? void 0 : _e.is_set) ? node.align.s_value : void 0);
  setProp(props, "vertical-align", ((_f = node.verticalAlign) == null ? void 0 : _f.is_set) ? node.verticalAlign.s_value : void 0);
  setProp(props, "flex-direction", ((_g = node.direction) == null ? void 0 : _g.is_set) ? node.direction.s_value : void 0);
  setProp(props, "src", ((_h = node.imageUrl) == null ? void 0 : _h.is_set) ? node.imageUrl.s_value : void 0);
  setProp(props, "d", ((_i = node.svgPath) == null ? void 0 : _i.is_set) ? node.svgPath.s_value : void 0);
  setProp(props, "view-box", ((_j = node.viewBox) == null ? void 0 : _j.is_set) ? node.viewBox.s_value : void 0);
  if ((_k = node.rotate) == null ? void 0 : _k.is_set) setProp(props, "rotate", String(node.rotate.f_value));
  if ((_l = node.scale) == null ? void 0 : _l.is_set) setProp(props, "scale", String(node.scale.f_value));
  setProp(props, "background-gradient", ((_m = node.linearGradient) == null ? void 0 : _m.is_set) ? node.linearGradient.s_value : void 0);
  ...
  const kids = (node.items || []).filter((child) => child && child.tagName && child.tagName !== "content").map(legacyNode);
  if (kids.length > 0) out.children = kids;
  return out;
}
function toLegacyEVG(doc) {
  return new EVG(stormToXml(doc));
}

// src/storm/index.ts
function parse(input, css) {
  const trimmed = input.trim();
...
var parseStorm = parse;
async function renderToFile(fileName, width, height, doc) {
